...
int bitCount(int x) {
  ...
  int mask1 = ( tmpmask1)|(tmpmask1<<16) ;  // 32 bit 01

  int tmpmask2 = (0x33)|(0x33<<8);
  int mask2 = (tmpmask2)|(tmpmask2<<16);  // 32 bit 0011

  int tmpmask3 = (0x0f)|(0x0f<<8);
  int mask3 = ( tmpmask3)|(tmpmask3<<16); // 32bit 00001111

  int mask4 = (0xff)|(0xff<<16); // 32bit 0000000011111111

  int mask5 = (0xff)|(0xff<<8); // 32bit 000000000000000011111111111111111
